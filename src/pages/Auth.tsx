  ...
  if (step === 'password' || step === 'signup') {
    return (
      <div className="min-h-screen flex">
        ...
        <div className="lg:hidden absolute inset-0 bg-gradient-to-br from-violet-600/20 to-indigo-800/20 pointer-events-none" />
      </div>
    );
  }
          ...
          <div className="space-y-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 bg-background text-muted-foreground text-sm font-medium">Ou</span>
              </div>
            </div>
