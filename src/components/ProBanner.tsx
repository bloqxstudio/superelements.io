...
export const ProBanner: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-gradient-to-r from-pro-gradient-from to-pro-gradient-to text-white shadow-lg animate-fade-in">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold truncate">
              Desbloqueie componentes Premium
            </p>
            <p className="text-xs text-white/80 hidden sm:block">
              Acesse nossa biblioteca completa de componentes profissionais
            </p>
          </div>
        </div>
